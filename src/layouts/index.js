...
class Layout extends Component {
  ...
  handlerScroll = () => {
    ...
    if (newHigh > oldHigh) {
      ...
      nav.style =
        " height:53px; width:100%;  position:fixed; top:-200px;left:0; transition:0.5s;"; //transition:0.4s;
    } else {
      nav.style =
        " height:53px; width:100%; position:fixed; top:0;left:0; transition:0.5s;";
    }
    this.setState(pre => ({
      oldHigh: newHigh
    }));
