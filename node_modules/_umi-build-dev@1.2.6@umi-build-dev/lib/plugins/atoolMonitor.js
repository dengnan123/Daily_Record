...
const _require2 = require('atool-monitor'),
      reportData = _require2.reportData,
      reportBuildData = _require2.reportBuildData;
  ...
  api.onDevCompileDone(({
    ...
    if (isFirstCompile && process.env.REPEAT_REPORT !== 'none') {
      ...
      const appData = {
        ...
        antdVersion: antdPath && require(join(antdPath, 'package.json')).version // 项目可能不依赖 antd，需要做判断
